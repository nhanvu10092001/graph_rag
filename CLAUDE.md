...
```
All services (PostgreSQL with pgvector, Neo4j, MinIO, nomic-embed-text-v1.5 via vLLM, PaddleOCR-VL via vLLM, FastAPI Backend, and React Frontend) will launch automatically.
