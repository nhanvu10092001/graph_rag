...
class IndexingService:
    ...
    def _validate_and_extract_file(self, context: Dict[str, Any]):
        ...
        collection_name = file_obj.collection_name
        filename = file_obj.documents_name or "unknown"
    ...
    def _apply_filename_metadata(self, texts: List[Document], filename: str):
        """Stamp each chunk with the source filename."""
        for text in texts:
    ...
    def index_sync(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        with timer.stage("chunking"):
            ...
            self._apply_filename_metadata(texts, filename)
