            ...
            {session ? (
              <>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[10px] text-slate-400 font-medium">Sẵn sàng phản hồi</span>
                </div>
              </>
            ) : (
              <>
                <h2 className="text-sm font-semibold text-slate-800">Graph RAG Assistant</h2>
                <p className="text-[10px] text-slate-400 font-medium">Chọn hoặc tạo hội thoại để bắt đầu</p>
              </>
            )}
          </div>
        </div>
          ...
          <div className="max-w-2xl mx-auto flex flex-col items-center justify-center py-10 space-y-8">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <p className="text-slate-500 text-sm max-w-md leading-relaxed">
                Hệ thống truy xuất tri thức Graph RAG, tích hợp Neo4j và LangGraph, sẵn sàng hỗ trợ bạn.
              </p>
            </div>

            <div className="w-full space-y-3">
              <h3 className="text-[10px] font-bold text-slate-400 tracking-wider font-mono text-center mb-1">GỢI Ý CHUYÊN MÔN</h3>
                ...
                >
                  ...
                  <div className={`flex flex-col max-w-[85%] min-w-0 space-y-1.5 ${isUser ? 'items-end' : 'items-start'}`}>
                    <div className="flex items-center gap-2 text-[10px] text-slate-400 font-mono flex-wrap overflow-hidden">
                      <span>{isUser ? 'Bạn' : (message.modelUsed || 'Graph RAG Assistant')}</span>
                      <span>•</span>
        ...
        <div className="max-w-3xl mx-auto relative">
          <div className="bg-slate-50 border border-slate-200 focus-within:border-indigo-500/80 focus-within:bg-white rounded-2xl shadow-sm transition-all p-2 flex items-end gap-2">
            <textarea
              ...
              placeholder={
                !session
                  ? "Chọn gợi ý ở trên hoặc nhập câu hỏi để bắt đầu..."
